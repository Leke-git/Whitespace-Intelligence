...
export default function IntelligencePage() {
  ...
  const fetchAnalyses = useCallback(async () => {
    setLoading(true);
    // In a real app, these would be generated by n8n and stored in a 'gap_analyses' table
    // For the MVP, we'll simulate this with dummy data if the table doesn't exist yet
      ...
      const dummyData: GapAnalysis[] = [
        {
          ...
          summary: 'High need index (0.95) with only 2 active NGOs in the nutrition sector.',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          >
            ...
            <p className="text-xl text-slate-400 leading-relaxed">
              We analyze real-time intervention data against regional need indices to identify underserved LGAs and prevent duplication of effort.
            </p>
          </motion.div>
        </div>
      </header>
